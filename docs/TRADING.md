...
7. Per-strategy and per-asset pause lists reviewed
8. Startup safety check passing
9. You are not in an ephemeral preview environment

**Do not activate live mode.** Paper-trade until out-of-sample and prospective results exist.

There is no kill switch. Paper entries are gated by the quality bar, cash, daily-loss circuit breaker, and concentration limits.
